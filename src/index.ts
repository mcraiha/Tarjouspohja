...
const kaupat: ReadonlyArray<KauppojenMaaritykset> = [
    ...
    { kauppa: Verkkokauppa.Datatronic, nimi: "Datatronic", urlit: ["www.datatronic.fi", "datatronic.fi"], maa: Maa.Suomi, naytaVeroerolaskuri: false, hintamuokkaus: eiHintamuokkausta, refTarkistus: eiRefTarkistusta},
    ...
    { kauppa: Verkkokauppa.Fanatical, nimi: "Fanatical", urlit: ["www.fanatical.com", "fanatical.com"], maa: Maa.Suomi, naytaVeroerolaskuri: false, hintamuokkaus: eiHintamuokkausta, refTarkistus: eiRefTarkistusta},
    ...
    { kauppa: Verkkokauppa.GreenManGaming, nimi: "Green Man Gaming", urlit: ["www.greenmangaming.com", "greenmangaming.com"], maa: Maa.Suomi, naytaVeroerolaskuri: false, hintamuokkaus: eiHintamuokkausta, refTarkistus: eiRefTarkistusta},
    ...
    { kauppa: Verkkokauppa.Steam, nimi: "Steam", urlit: ["store.steampowered.com"], maa: Maa.Suomi, naytaVeroerolaskuri: false, hintamuokkaus: eiHintamuokkausta, refTarkistus: eiRefTarkistusta},
